    ...
    <section className="page section" id="about" ref={sectionRef}>
      <div className="hero">
        <div className="hero-copy">
          <p className="hero-kicker">ABOUT ME</p>
          <h1 className="hero-title">김정희</h1>
          <p className="hero-name-en">Kim Jeong Hee</p>
          <p className="hero-tagline">데이터 기술자 | 논리적이고 AI 접목 가능한 데이터 기술자입니다.</p>
